...
ga('create', '${googleAnalyticsId}', 'auto'); ga('send', 'pageview');` }}
    ...
    const mainCss = <style media="screen" type="text/css" dangerouslySetInnerHTML={{ __html: 'body, h1, h2, h3, h4, h5, h6 { margin: 0; }' }} />;
    ...
    return (
      <html lang="en">
        ...
        <body style={{ backgroundColor: `${grey200}` }} dangerouslySetInnerHTML={{ __html: bodyHtml }} />
      </html>
    );
  }
